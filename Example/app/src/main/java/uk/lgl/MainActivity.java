...
public class MainActivity extends Activity {
    ...
    public String sUser = "";
    private String BackgroundColor = "#ff1f2b3f";
        ...
        public void onPostExecute(String str) {
            ...
            if (!str.trim().isEmpty()) {
                if (str.trim().contains("\"code\":\"1\"")) {
                    ...
                    try {
                        MainActivity.this.startService(new Intent(MainActivity.this, FloatingModMenuService.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
            Toast.makeText(this.getApplicationContext(), "Overlay permission is required in order to show mod menu. Restart the game after you allow permission", Toast.LENGTH_LONG).show();
            Toast.makeText(this.getApplicationContext(), "Overlay permission is required in order to show mod menu. Restart the game after you allow permission", Toast.LENGTH_LONG).show();
